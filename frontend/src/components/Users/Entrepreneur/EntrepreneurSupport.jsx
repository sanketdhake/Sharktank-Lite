import { EntrepreneurSupportAPI } from "../../../services/User/admin/adminServices";
...
export default function EntrepreneurSupport() {
  ...
  const { mutateAsync, isPending, isError, isSuccess, error } = useMutation({
    mutationFn: EntrepreneurSupportAPI,
    mutationKey: ["entrepreneur_support"],
  });
  ...
  return (
    <div className="max-w-md mx-auto my-10 p-6 bg-white shadow-lg rounded-lg">
      <div className="text-center mb-4">
        <h2 className="text-2xl font-semibold">Entrepreneur Support</h2>
      </div>
